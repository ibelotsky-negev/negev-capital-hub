        ...
        <div className="grid gap-12 lg:grid-cols-5 lg:gap-16 lg:items-center">
          ...
          <div className="lg:col-span-3">
            <p className="text-xs font-medium uppercase tracking-[0.2em] text-primary-foreground/60">
              Biotech Venture Capital · Cayman Islands
            </p>
            ...
            <p className="mt-6 max-w-xl text-base md:text-lg text-primary-foreground/70 leading-relaxed">
              Negev Capital is a $30M+ Cayman-domiciled biotech venture fund. Our portfolio includes the AbbVie acquisition of Gilgamesh Pharmaceuticals (up to $1.2B, 2025) and the Otsuka acquisition of Mindset Pharma (2023). Today we continue building through Negev Labs, our CNS venture studio.
            </p>
